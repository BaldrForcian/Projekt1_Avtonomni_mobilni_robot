...
class WT901CNode(Node):
    ...
    def __init__(self):
        ...
        self.declare_parameter('use_9axis', False)
        ...
        #self.orient_pub = self.create_publisher(Float64MultiArray, '/imu/orient', 10)
...
#-------------Branje vrednosti IMU in Publishing vrednosti------------------------------#
    def timer_callback(self):
        ...
        block = self.read_registers(REG_AX, 6)
        if block is None:
        ...
        #orient_msg = Float64MultiArray()
        #orient_msg.data = [
        #    (block[9] / 32768.0) * 180.0,
        #    (block[10] / 32768.0) * 180.0,
        #    (block[11] / 32768.0) * 180.0
        #]
